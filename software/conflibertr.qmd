...
::: {.pkg-badges}
<img src="https://www.r-pkg.org/badges/version/conflibertR" alt="CRAN status badge"/>
<img src="https://github.com/shreyasmeher/conflibertR/actions/workflows/R-CMD-check.yaml/badge.svg" alt="R-CMD-check status badge"/>
:::
...
paper (Hu et al. 2022) and our *Political Analysis* paper validating these
models against generative LLMs for conflict text classification
(Brandt et al. 2025). `citation("conflibertR")` has the full details.

```bibtex
@article{brandt2025extractive,
  title   = {Extractive versus Generative Language Models for
             Political Conflict Text Classification},
  author  = {Brandt, Patrick T. and Alsarra, Sultan and
             D'Orazio, Vito and Heintze, Dagmar and Khan, Latifur and
             Meher, Shreyas and Osorio, Javier and Sianan, Marcus},
