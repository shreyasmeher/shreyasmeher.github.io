...
#| echo: true
#| warning: false
pacman::p_load(ggplot2, tidyr, dplyr, haven, gridExtra, ggExtra)
...
```{r}
#| warning: false
fit1<-lm(Tondu~age, data=sel_dat)
summary(fit1)
...
taei<-ggplot(sel_dat, aes(age, Tondu, colour=votetsai))+
  geom_point()
...
barplot(table(sel_dat$Tondu),xlab="Tondu")
```
