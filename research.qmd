...
[with C. Egger & A. Zhelyazkova · Forthcoming, *International Political Science Review*]{.pub-meta}
<details class="abstract"><summary>Abstract</summary>
...
::: {.pub-entry}
[The Political Returns to ICT Investment: Information Control of Authoritarian Regimes]{.pub-title}
[with P. Zhang · Forthcoming, *Proceedings of the International Congress on Information and Communication Technology (ICICT 2027)*, Springer Lecture Notes in Networks and Systems]{.pub-meta}
<details class="abstract"><summary>Abstract</summary>
<p>Why does ICT investment appear to generate lower economic returns in autocracies than in democracies? We argue that authoritarian governments invest in ICT for political as well as economic purposes, and that one important political return is enhanced capacity for information control. Using panel data from Freedom House, V-Dem, and the Open Observatory of Network Interference (OONI), we identify two distinct modes of authoritarian information control through cluster analysis: a <em>Strong Control</em> regime, characterized by extensive state-run filtering and blocking, and a <em>Weak Control</em> regime, which is less infrastructure-intensive. We show that these regimes correspond to systematically different censorship behaviors. More importantly, greater state ICT capacity predicts the adoption of Strong Control: governments with stronger operational capabilities rely more on direct Internet blocking and less on private platforms. The results are consistent with a mechanism in which ICT investment expands state capacity, which in turn facilitates infrastructure-intensive information control and is consequently associated with lower Internet freedom. Conventional measures of economic return may understate the value authoritarian governments derive from ICT investment because they omit its political return.</p>
</details>
:::

::: {.pub-entry}
[Selective Scrutiny: Single-Party Majority and the Strategic Withdrawal of Parliamentary Oversight in India]{.pub-title}
[Revise & resubmit, *The Journal of Legislative Studies*]{.pub-meta}
<details class="abstract"><summary>Abstract</summary>
