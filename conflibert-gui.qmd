...
A browser-based NLP toolkit for conflict and political violence text analysis. Built on [ConfliBERT](https://eventdata.utdallas.edu/conflibert/), the GUI provides an accessible interface for named entity recognition, text classification, question answering, and model fine-tuning, with no coding required.
